...
```bash
apigw-lambda-dynamodb-crud-ts-sample-1$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
apigw-lambda-dynamodb-crud-ts-sample-1$ sam logs -n HelloWorldFunction --stack-name apigw-lambda-dynamodb-crud-ts-sample-1 --tail
```
...
```bash
apigw-lambda-dynamodb-crud-ts-sample-1$ cd hello-world
